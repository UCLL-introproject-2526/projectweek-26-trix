...
class Huntress:
    def __init__(self, x, y):
        self.animations = {
            "idle":   Animation(load_images("Sprites_Huntress/idle"),   0.10, loop=True),
            "run":    Animation(load_images("Sprites_Huntress/run"),    0.15, loop=True),
            "jump":   Animation(load_images("Sprites_Huntress/jump"),   0.12, loop=True),
            "attack": Animation(load_images("Sprites_Huntress/attack"), 0.20, loop=False),
        }
