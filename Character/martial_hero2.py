...
HBX, HBY, HBW, HBH = 85, 72, 26, 57


class MartialHero2:
    def __init__(self, x, y):
        self.animations = {
            "idle":   Animation(load_images("Sprites_Martial_Hero_2/idle"),   0.10, loop=True),
            "run":    Animation(load_images("Sprites_Martial_Hero_2/run"),    0.15, loop=True),
            "jump":   Animation(load_images("Sprites_Martial_Hero_2/jump"),   0.12, loop=True),
            "attack": Animation(load_images("Sprites_Martial_Hero_2/attack"), 0.20, loop=False),
        }
    ...
    def create_attack_hitbox(self):
        ...
        sword_y = self.rect.y + int(60 * SCALE)
